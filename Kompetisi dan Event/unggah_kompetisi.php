...
<body>
    ...
    <div class="container">
        ...
        <h5>Unggah Kompetisi dan Event</h5><br>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    uploadBox.addEventListener('dragleave', dragLeaveHandler);
        ...
        // Fungsi untuk mengunggah kompetisi ke server
        function unggahKompetisi(event) {
            event.preventDefault();

            // Mendapatkan form element
            const form = event.target;

            // Membuat objek FormData untuk mengirim data formulir, termasuk gambar yang diunggah
            ...
            .then(message => {
                alert(message); // Menampilkan pesan hasil dari server
                   ...
                   // Alihkan pengguna ke halaman "Event.php" setelah proses unggah kompetisi selesai
            window.location.href = "/BOOKSTAGRAM/Kompetisi dan Event/Halaman Event/Event.php";
            })
            .catch(error => {
                console.error("Error:", error);
            });
