...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="datakompetisi.php">
                ...
                <tbody>
                    ...
                    foreach ($dataKompetisi as $kompetisi) {
                        ...
                        echo "<td class='text-center aksi-buttons'>
                                ...
                                <a href='delete_kompetisi.php?id=" . $kompetisi['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus kompetisi ini?\")'>Hapus</a>
                              </td>";
                        echo "</tr>";
                    }
                    ?>
